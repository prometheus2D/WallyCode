...
[Verb("provider", HelpText = "List providers, list a provider's models, or set the default provider and model.")]
internal sealed class ProviderCommandOptions
{
    [Value(0, MetaName = "name", Required = false, HelpText = "Provider name for --set, --models, or --model.")]
